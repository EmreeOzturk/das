  ...
  return (
    <section className="w-full pb-20 relative overflow-hidden">
      <div className="container  mx-auto px-12">
        ...
        <div
          id="solutions"
          className="flex flex-col items-end mb-20 w-full md:pr-32"
        >
          <motion.h2
        ...
        {/* Solutions Grid */}
        <div className="grid grid-cols-4 gap-x-20 gap-y-32">
          {solutions.map((solution) => (
            ...
            >
              ...
              <div className="flex  flex-col gap-1">
                ...
                {solution.highlight && (
                  <p className="text-2xl pt-4 pb-2 leading-tight">
                ...
                {solution && (
                  <p className="text-white text-xl leading-tight"></p>
                )}
              </div>
            </motion.div>
          ))}
