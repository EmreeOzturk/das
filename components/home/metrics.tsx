  ...
  return (
    <section className="w-full py-20 relative ">
      <div className="absolute top-[50%] right-0 translate-y-[-50%] w-[400px] h-[400px]">
        <Image src="/globe.svg" alt="Globe" fill className="" />
      ...
      <div className="px-12 mt-[336px]">
        ...
        ></motion.h2>
        {/* Stats Grid */}
        <div className="flex gap-4 pb-20 mb-20 w-1/2 relative ">
          ...
          <div className="w-full text-center">
            ...
            <div className="text-[#00ccff] text-2xl mb-4 font-light">
              200.000
            </div>
            <div className="relative mt-20 h-[200px] w-full">
              <Image
